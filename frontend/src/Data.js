export const blogLinks = [
  ...
  { name: "Create post", link: "/create-post", icon: "pencil-outline" },
  { name: "My Blogs", link: "/my-post", icon: "folder-outline" },
];
export const userLinks = [
  { name: "Log in", link: "/login", icon: "log-out-outline" },
  { name: "Create account", link: "/signin", icon: "person-add-outline" },
];
